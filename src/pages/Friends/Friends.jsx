...
import { Container, SearchAndHeading, Navigation, FriendsList } from '../../components/Friends';

function Friends() {
  const friends = useSelector(userFriendsSelector);
  //prettier-ignore
  const candidatePaths = ['allFriends', 'recentlyAddedFriends', 'upComingBirthdays', 'muntualFriends', 'pendingRequests', 'sentRequests'];
